...
class SendConfirmRevokeKomu implements ShouldQueue
{
    ...
    {
        $context = ['job' => 'SendConfirmRevokeKomu', 'email' => $this->it_ncc_email];
        ...
        if ($komuSuccess) {
            Log::info("[Job] Komu message sent successfully", $context);
        } else {
            Log::error("[Job] Komu message failed", $context);
        }
    }
}